...
function changeLike(id,idkey, from) {
    if (getCookie('gsw2017user') == null) {
        ...
        if (likeImg == -1) {
            ...
            xmlhttp.onreadystatechange = function () {
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                    document.getElementById('likeImg' + id).src = 'https://song.gushiwen.org/siteimg/shoucang.png';
...
function ShowYizhu(id) {
    if (document.getElementById('leftbtn' + id).innerHTML == "译注") {
        ...
        if (document.getElementById('rightbtn' + id)) {
            ...
            xmlhttp.open("GET", "/guwen/showyizhu/?id=" + id, false);
            xmlhttp.send();
        }
    }
    else {
    ...
    if (document.getElementById('bookPlay' + id).style.display == "none") {
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgBook' + id).src = "http://poetry.cdn.13520v.com/poetry/images/speaker.png";
                document.getElementById("bookPlay" + id).innerHTML = xmlhttp.responseText;
            }
        }
